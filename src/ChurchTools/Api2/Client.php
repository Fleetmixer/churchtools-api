...
class Client extends \ChurchTools\Api2\Runtime\Client\Client
{
    /**
    ...
    {
        return $this->executeEndpoint(new \ChurchTools\Api2\Endpoint\GetApiInfo(), $fetch);
    }
    /**
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     *
    ...
    {
        return $this->executeEndpoint(new \ChurchTools\Api2\Endpoint\GetCurrentUser(), $fetch);
    }
    /**
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
    ...
    {
        return $this->executeEndpoint(new \ChurchTools\Api2\Endpoint\GetAllCampuses(), $fetch);
    }
    /**
     * 
     *
    ...
    {
        return $this->executeEndpoint(new \ChurchTools\Api2\Endpoint\CreateNewCampus($requestBody), $fetch);
    }
    /**
     * 
     *
    ...
    {
        return $this->executeEndpoint(new \ChurchTools\Api2\Endpoint\DeleteCampusById($id), $fetch);
    }
    /**
     * 
     *
    ...
    {
        return $this->executeEndpoint(new \ChurchTools\Api2\Endpoint\GetCampusById($id), $fetch);
    }
    /**
     * 
     *
    ...
    {
        return $this->executeEndpoint(new \ChurchTools\Api2\Endpoint\PutCampusById($id, $requestBody), $fetch);
    }
    /**
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
    ...
    {
        return $this->executeEndpoint(new \ChurchTools\Api2\Endpoint\GetAllFields(), $fetch);
    }
    /**
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
    ...
    {
        return $this->executeEndpoint(new \ChurchTools\Api2\Endpoint\GetAllStatuses(), $fetch);
    }
    /**
     * 
     *
    ...
    {
        return $this->executeEndpoint(new \ChurchTools\Api2\Endpoint\CreateNewStatus($requestBody), $fetch);
    }
    /**
     * 
     *
    ...
    {
        return $this->executeEndpoint(new \ChurchTools\Api2\Endpoint\DeleteStatusById($id), $fetch);
    }
    /**
     * 
     *
    ...
    {
        return $this->executeEndpoint(new \ChurchTools\Api2\Endpoint\GetStatusById($id), $fetch);
    }
    /**
     * 
     *
    ...
    {
        return $this->executeEndpoint(new \ChurchTools\Api2\Endpoint\PutStatusById($id, $requestBody), $fetch);
    }
    /**
     ...
     */
    public function getAllPersons(array $queryParameters = array(), string $fetch = self::FETCH_OBJECT, array $accept = array())
    {
        return $this->executeEndpoint(new \ChurchTools\Api2\Endpoint\GetAllPersons($queryParameters, $accept), $fetch);
    }
    /**
     ...
     */
    public function createPerson(\ChurchTools\Api2\Model\PersonsPostBody $requestBody, array $queryParameters = array(), string $fetch = self::FETCH_OBJECT, array $accept = array())
    {
        return $this->executeEndpoint(new \ChurchTools\Api2\Endpoint\CreatePerson($requestBody, $queryParameters, $accept), $fetch);
    }
    /**
     * 
     *
     ...
     */
    public function getPersonProperties(?\ChurchTools\Api2\Model\PersonsPropertiesPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \ChurchTools\Api2\Endpoint\GetPersonProperties($requestBody), $fetch);
    }
    /**
     * 
     *
    ...
    {
        return $this->executeEndpoint(new \ChurchTools\Api2\Endpoint\DeletePerson($id), $fetch);
    }
    /**
     ...
     */
    public function getPersonById(string $id, string $fetch = self::FETCH_OBJECT, array $accept = array())
    {
        return $this->executeEndpoint(new \ChurchTools\Api2\Endpoint\GetPersonById($id, $accept), $fetch);
    }
    /**
     ...
     */
    public function patchPerson(string $id, \stdClass $requestBody, string $fetch = self::FETCH_OBJECT, array $accept = array())
    {
        return $this->executeEndpoint(new \ChurchTools\Api2\Endpoint\PatchPerson($id, $requestBody, $accept), $fetch);
    }
    /**
     * 
     *
    ...
    {
        return $this->executeEndpoint(new \ChurchTools\Api2\Endpoint\GetPersonTags($id), $fetch);
    }
    /**
    ...
    {
        return $this->executeEndpoint(new \ChurchTools\Api2\Endpoint\GetPersonRelationships($id), $fetch);
    }
    /**
     ...
     */
    public function getAllPersonSettings(string $id, string $fetch = self::FETCH_OBJECT, array $accept = array())
    {
        return $this->executeEndpoint(new \ChurchTools\Api2\Endpoint\GetAllPersonSettings($id, $accept), $fetch);
    }
    /**
     ...
     */
    public function getPersonModuleSettings(string $id, string $module, string $fetch = self::FETCH_OBJECT, array $accept = array())
    {
        return $this->executeEndpoint(new \ChurchTools\Api2\Endpoint\GetPersonModuleSettings($id, $module, $accept), $fetch);
    }
    /**
    ...
    {
        return $this->executeEndpoint(new \ChurchTools\Api2\Endpoint\DeletePersonSetting($id, $module, $attribute), $fetch);
    }
    /**
     ...
     */
    public function getPersonSetting(string $id, string $module, string $attribute, string $fetch = self::FETCH_OBJECT, array $accept = array())
    {
        return $this->executeEndpoint(new \ChurchTools\Api2\Endpoint\GetPersonSetting($id, $module, $attribute, $accept), $fetch);
    }
    /**
     ...
     */
    public function updatePersonSetting(string $id, string $module, string $attribute, string $fetch = self::FETCH_OBJECT, array $accept = array())
    {
        return $this->executeEndpoint(new \ChurchTools\Api2\Endpoint\UpdatePersonSetting($id, $module, $attribute, $accept), $fetch);
    }
    /**
     ...
     */
    public function getPersonEvents(string $id, array $queryParameters = array(), string $fetch = self::FETCH_OBJECT, array $accept = array())
    {
        return $this->executeEndpoint(new \ChurchTools\Api2\Endpoint\GetPersonEvents($id, $queryParameters, $accept), $fetch);
    }
    /**
    ...
    {
        return $this->executeEndpoint(new \ChurchTools\Api2\Endpoint\GetAllGroups($queryParameters), $fetch);
    }
    /**
     * 
     *
    ...
    {
        return $this->executeEndpoint(new \ChurchTools\Api2\Endpoint\GetGroupById($id), $fetch);
    }
    /**
    ...
    {
        return $this->executeEndpoint(new \ChurchTools\Api2\Endpoint\GetAllGroupMembers($id, $queryParameters), $fetch);
    }
    /**
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
    ...
    {
        return $this->executeEndpoint(new \ChurchTools\Api2\Endpoint\GetAllServiceGroups(), $fetch);
    }
    /**
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
    ...
    {
        return $this->executeEndpoint(new \ChurchTools\Api2\Endpoint\GetAllServices(), $fetch);
    }
    /**
     ...
     */
    public function getTags(array $queryParameters = array(), string $fetch = self::FETCH_OBJECT, array $accept = array())
    {
        return $this->executeEndpoint(new \ChurchTools\Api2\Endpoint\GetTags($queryParameters, $accept), $fetch);
    }
    /**
     * 
     *
     ...
     */
    public function saveTag(\ChurchTools\Api2\Model\TagsPostBody $requestBody, string $fetch = self::FETCH_OBJECT, array $accept = array())
    {
        return $this->executeEndpoint(new \ChurchTools\Api2\Endpoint\SaveTag($requestBody, $accept), $fetch);
    }
    /**
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
    ...
    {
        return $this->executeEndpoint(new \ChurchTools\Api2\Endpoint\GetAllDepartments(), $fetch);
    }
    /**
     * 
     *
    ...
    {
        return $this->executeEndpoint(new \ChurchTools\Api2\Endpoint\DeleteFiles($domainType, $domainIdentifier), $fetch);
    }
    /**
     * 
     *
     ...
     */
    public function uploadFiles(string $domainType, string $domainIdentifier, ?\ChurchTools\Api2\Model\FilesDomainTypeDomainIdentifierPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT, array $accept = array())
    {
        return $this->executeEndpoint(new \ChurchTools\Api2\Endpoint\UploadFiles($domainType, $domainIdentifier, $requestBody, $accept), $fetch);
    }
    /**
     ...
     */
    public function getAllLogs(array $queryParameters = array(), string $fetch = self::FETCH_OBJECT, array $accept = array())
    {
        return $this->executeEndpoint(new \ChurchTools\Api2\Endpoint\GetAllLogs($queryParameters, $accept), $fetch);
    }
    /**
     ...
     */
    public function getLogById(int $id, string $fetch = self::FETCH_OBJECT, array $accept = array())
    {
        return $this->executeEndpoint(new \ChurchTools\Api2\Endpoint\GetLogById($id, $accept), $fetch);
    }
    /**
     * 
     *
     ...
     */
    public function getAllTemplates(string $fetch = self::FETCH_OBJECT, array $accept = array())
    {
        return $this->executeEndpoint(new \ChurchTools\Api2\Endpoint\GetAllTemplates($accept), $fetch);
    }
    /**
     * 
     *
     ...
     */
    public function createTemplate(\ChurchTools\Api2\Model\CalendarsAppointmentsTemplatesPostBody $requestBody, string $fetch = self::FETCH_OBJECT, array $accept = array())
    {
        return $this->executeEndpoint(new \ChurchTools\Api2\Endpoint\CreateTemplate($requestBody, $accept), $fetch);
    }
    /**
     * 
     *
    ...
    {
        return $this->executeEndpoint(new \ChurchTools\Api2\Endpoint\DeleteTemplate($templateId), $fetch);
    }
    /**
     * 
     *
     ...
     */
    public function getTemplateById(int $templateId, string $fetch = self::FETCH_OBJECT, array $accept = array())
    {
        return $this->executeEndpoint(new \ChurchTools\Api2\Endpoint\GetTemplateById($templateId, $accept), $fetch);
    }
    /**
     * 
     *
     ...
     */
    public function updateTemplate(int $templateId, \stdClass $requestBody, string $fetch = self::FETCH_OBJECT, array $accept = array())
    {
        return $this->executeEndpoint(new \ChurchTools\Api2\Endpoint\UpdateTemplate($templateId, $requestBody, $accept), $fetch);
    }
    /**
     ...
     */
    public function getAgendaForEvent(int $eventId, string $fetch = self::FETCH_OBJECT, array $accept = array())
    {
        return $this->executeEndpoint(new \ChurchTools\Api2\Endpoint\GetAgendaForEvent($eventId, $accept), $fetch);
    }
    /**
     ...
     */
    public function sendAgendaEmail(\ChurchTools\Api2\Model\AgendasSendPostBody $requestBody, string $fetch = self::FETCH_OBJECT, array $accept = array())
    {
        return $this->executeEndpoint(new \ChurchTools\Api2\Endpoint\SendAgendaEmail($requestBody, $accept), $fetch);
    }
    /**
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
    ...
    {
        return $this->executeEndpoint(new \ChurchTools\Api2\Endpoint\GetAllGroupTypeRoles(), $fetch);
    }
    /**
     * 
     *
    ...
    {
        return $this->executeEndpoint(new \ChurchTools\Api2\Endpoint\GetMasterdataPersonRoleByRoleId($roleId), $fetch);
    }
