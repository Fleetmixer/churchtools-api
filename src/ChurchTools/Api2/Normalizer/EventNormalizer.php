...
class EventNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        if (\array_key_exists('eventServices', $data)) {
            $values = array();
    ...
    public function normalize($object, $format = null, array $context = array())
    {
        ...
        if ($object->isInitialized('eventServices') && null !== $object->getEventServices()) {
            $values = array();
    ...
    {
        return array('ChurchTools\\Api2\\Model\\Event' => false);
    }
}