...
class AgendaNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function normalize($object, $format = null, array $context = array())
    {
        ...
        if ($object->isInitialized('isFinal') && null !== $object->getIsFinal()) {
            $data['isFinal'] = $object->getIsFinal();
        }
        if ($object->isInitialized('calendarId') && null !== $object->getCalendarId()) {
    ...
    {
        return array('ChurchTools\\Api2\\Model\\Agenda' => false);
    }
}